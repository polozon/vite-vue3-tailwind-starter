<template>
  <div class="fixed top-15 w-full max-w-sm px-0">
            ...
            <div class="bg-gray-50 p-4">
              ...
              >
                ...
                <span class="block text-sm text-gray-500">
                  Bör vi skriva mer av, men vem fan har tid med det?
                </span>
              </a>
            </div>
          </div>
...
const solutions = [
  {
    name: 'Muttrar',
    description: 'Uppskatta hur enkelt man kan tappa bort dem',
    href: '##',
    icon: `
      <svg
        width="48"
  ...
  {
    name: 'Stilar',
    description: 'TailwindCSS är the shit!',
    href: '##',
    icon: `
      <svg
        width="48"
  ...
  {
    name: 'Staplar',
    description: 'Mät saker, bara för att...',
    href: '##',
    icon: `
      <svg
        width="48"
